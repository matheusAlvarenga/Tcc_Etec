      ...
      <nav class="navbar navbar-default menuu">
        ...
        <div class="col-md-2">
           <div class="navbar-header logo menu">
             <a href="adminpage.php" class="navbar-brand"><img src="img/logo_grande.png"></a>
           </div>
        </div>
         <div class="col-md-5 col-sm-10 col-xs-10">
          <ul class="nav navbar-nav navbar-right menu">
            <li><a href="#">G.Produtos</a></li>
            <li><a href="#">G.Clientes</a></li>
            <li><a href="#">G.Vendas</a></li>
            <li><a href="#">G.Admins</a></li>
          </ul>
        </div>
      </nav> 
    </div>
